<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/FrontFaculty.master" AutoEventWireup="true" CodeFile="ProgrammingPaper.aspx.cs" Inherits="Faculty_ExamQuestions_ProgrammingPaer" %>
...
<br />
    ...
    <asp:EntityDataSource ID="EntityDataSource1" runat="server" ConnectionString="name=collegeEntities1" DefaultContainerName="collegeEntities1" EnableDelete="True" EnableFlattening="False" EnableInsert="True" EnableUpdate="True" EntitySetName="ProgrammingQuestions">
