<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Aptitude.aspx.cs" Inherits="Student_Exams_Aptitude" %>
...
<body onload="f1()">
    <form id="form1" runat="server">
     ...
     <div id="showtime" style="background-color:#39dbcc;border:solid;border-width:5px;"> 
        ...
        <br />
        <br />
          <div style="overflow:scroll;height:700px;border:none">
          <asp:ListView ID="ListView1" runat="server" DataKeyNames="QuestionId" DataSourceID="SqlDataSource1">
        <ItemTemplate>
            <span style="">                
...
<br /></span>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:collegeConnectionString1 %>" SelectCommand="SELECT TOP (10) QuestionId, QuestionStatement, Option1, Option2, Option3, Option4, CorrectOption, QuestionImage FROM AptiQuestions ORDER BY NEWID()"></asp:SqlDataSource>
    <br />
