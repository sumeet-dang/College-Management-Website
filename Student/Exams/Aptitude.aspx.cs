...
public partial class Student_Exams_Aptitude : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
       ...
       cmd.Parameters.AddWithValue("@e2", "Aptitude");
       cmd.Parameters.AddWithValue("@e3", date);
       cmd.Parameters.AddWithValue("@e4", marks);
       cmd.ExecuteNonQuery();
       cmd.Dispose();
       connection.conn.Close();
       // Response.Redirect("FinishExam.aspx?Marks=" + marks.ToString());
