<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Programming.aspx.cs" Inherits="Student_Exams_Programming" %>
...
<br /></span>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:collegeConnectionString1 %>" SelectCommand="SELECT TOP (10) QuestionId, Option1, Option2, Option3, Option4, CorrectOption, QuestionStatement FROM ProgrammingQuestions ORDER BY NEWID()"></asp:SqlDataSource>
    <br />
